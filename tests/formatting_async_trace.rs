...
fn async_trace() {
...

	{
		...
		log.set_level(Level::Trace).add_sink(mem_sink).set_async(true);
	...
	let want = "2026-03-04 15:10:15.000 [TRA] added new log sink name=\"default log string\" total=1 async=false caller_filename=\"src/some_file.rs\" caller_line=567\n\
	            2026-03-04 15:10:16.234 [TRA] enabled async log updates total_async_loggers=1 caller_filename=\"src/some_file.rs\" caller_line=577\n\
				...
				2026-03-04 15:10:21.170 [TRA] enabled async log updates total_async_loggers=2 caller_filename=\"src/some_file.rs\" caller_line=587\n\
				...
				2026-03-04 15:10:26.106 [TRA] disabled async log updates number=1 total_async_loggers=1 caller_filename=\"src/some_file.rs\" caller_line=597\n\
				2026-03-04 15:10:27.340 [TRA] disabled async log updates total_async_loggers=0 caller_filename=\"src/some_file.rs\" caller_line=607";
